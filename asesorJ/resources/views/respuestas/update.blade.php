...
<input type="hidden" class="form-control" value="{{ $list[0]['id'] }}" id="id" name="id">
  ...
  <div class="col-md-9">
    <div class="form-group">
      ...
      <input type="number" class="form-control" value="{{ $list[0]['idPregunta'] }}" id="idPregunta" name="idPregunta">
    </div>
  </div>
  <div class="col-md-9">
    <div class="form-group">
      <label for="respuesta">respuesta: *</label>
      <input type="text" class="form-control" value="{{ $list[0]['respuesta'] }}" id="respuesta" name="respuesta">
    </div>
  </div>
  <div class="col-md-9">
    <div class="form-group">
      <label for="calificacion">calificacion: *</label>
      <input type="number" class="form-control" value="{{ $list[0]['calificacion'] }}" id="calificacion" name="calificacion">
    </div>
  </div>
  <div class="col-md-10">
