...
<div class="container">
  <h2>Actualizar Notificaciones</h2>
...
<input type="hidden" class="form-control" value="{{ $list[0]['id'] }}" id="id" name="id">
  ...
  <div class="col-md-9">
    <div class="form-group">
      ...
      <input type="text" class="form-control" value="{{ $list[0]['Message'] }}" id="Message" name="Message">
    </div>
  </div>
  <div class="col-md-9">
    <input type="hidden" name="ifEmail" value="{{ $list[0]['ifEmail'] }}" > 
  </div>
  <div class="col-md-9">
    <div class="form-group">
      <label for="status">status: *</label>
      <input type="number" value="{{ $list[0]['status'] }}" class="form-control" id="status" name="status">
    </div>
  </div>
  <div class="col-md-10">
