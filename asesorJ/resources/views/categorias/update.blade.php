...
<div class="container">
  ...
  <div class="col-md-9">
    ...
    <input type="hidden" class="form-control" value="{{ $list[0]['id'] }}" id="id" name="id">
      ...
      <input type="text" class="form-control" value="{{ $list[0]['nombre'] }}" id="nombre" name="nombre">
    </div>
  </div>
  <div class="col-md-9">
    <div class="form-group">
      <label for="descripcion">Descripción:</label>
      <textarea class="form-control" id="descripcion" name="descripcion">{{ $list[0]['descripcion'] }}</textarea>
    </div>
  </div>
  <div class="col-md-9">
    <div class="form-group">
      <label for="descripcion">Administrador:</label>
      <input type="text" class="form-control" id="administrador" value="{{ $list[0]['administrador'] }}" name="administrador">
    </div>
  </div>
  <div class="col-md-10">
