...
<div class="container">
  <h2>Actualizar Contador preguntas</h2>
  ...
  <div class="col-md-9">
    <div class="form-group">
      ...
      <input type="number" class="form-control" value="{{ $list[0]['contador'] }}" id="contador" name="contador">
    </div>
  </div>
  <div class="col-md-9">
    <div class="form-group">
      <label for="idRespuesta">idRespuesta: *</label>
      <input type="number" class="form-control" value="{{ $list[0]['idRespuesta'] }}" id="idRespuesta" name="idRespuesta">
    </div>
  </div>
  <div class="col-md-9">
    <div class="form-group">
      <label for="idAbogado">idAbogado: *</label>
      <input type="number" class="form-control" value="{{ $list[0]['idAbogado'] }}" id="idAbogado" name="idAbogado">
    </div>
  </div>
  <div class="col-md-10">
